...
You can integrate it with any Javascript runtime and server with this package.
...
- **Feature complete** - Supports all Inertia.js v2 features (besides the official Laravel features like precognition)
