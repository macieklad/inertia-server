...
import { createInertia, prop, mergedProp } from "../src/index";
import { elysiaAdapter } from "../src/elysia";
import type { InertiaPage, FlashAdapter } from "../src/types";
...
describe("Error bags", () => {
  test("staged errors are included in page props", async () => {
    ...
    expect(page.props.errors).toEqual({ email: "Email is required" });
  });
